...
(function (window, undefined) {
    var jQuery = function (selector, context) {
        ...
        }, _jQuery = window.jQuery, _$ = window.$, document = window.document, rootjQuery,
        quickExpr = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, isSimple = /^.[^:#\[\.,]*$/, rnotwhite = /\S/,
        rtrim = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, rsingleTag = /^<(\w+)\s*\/?>(?:<\/\1>)?$/,
        userAgent = navigator.userAgent.toLowerCase(), readyBound = false, readyList = [], DOMContentLoaded,
        toString = Object.prototype.toString, hasOwnProperty = Object.prototype.hasOwnProperty,
        push = Array.prototype.push, slice = Array.prototype.slice, indexOf = Array.prototype.indexOf;
    ...
    (function () {
        ...
        var root = document.documentElement, script = document.createElement("script"),
            div = document.createElement("div"), id = "script" + now();
    ...
    function liveHandler(event) {
        var stop = true, elems = [], selectors = [], args = arguments, related, match, fn, elem, j, i, data,
    ...
    var rclass = /[\n\t]/g, rspace = /\s+/, rreturn = /\r/g, rspecialurl = /href|src|style/, rtype = /(button|input)/i,
        rfocusable = /(button|input|object|select|textarea)/i, rclickable = /^(a|area)$/i;
    jQuery.fn.extend({
    ...
    jQuery.each({
        removeAttr: function (name) {
            ...
            if (type === "string") {
                var isBool = typeof state === "boolean", className, i = 0, classNames = classNames.split(rspace);
    ...
    var rinlinejQuery = / jQuery\d+="(?:\d+|null)"/g, rleadingWhitespace = /^\s+/, rxhtmlTag = /(<([\w:]+)[^>]*?)\/>/g,
        rselfClosing = /^(?:area|br|col|embed|hr|img|input|link|meta|param)$/i, rtagName = /<([\w:]+)/,
        rtbody = /<tbody/i, rhtml = /<|&\w+;/, fcloseTag = function (all, front, tag) {
    ...
    jQuery.fn.extend({
        text: function (text) {
            ...
            if (value === undefined) {
                return this[0] ? this[0].innerHTML.replace(rinlinejQuery, "") : null
            } else {
    ...
    var rexclude = /z-?index|font-?weight|opacity|zoom|line-?height/i, ralpha = /alpha\([^)]*\)/,
        ropacity = /opacity=([^)]*)/, rfloat = /float/i, rdashAlpha = /-([a-z])/ig, rupper = /([A-Z])/g,
    ...
    var jsc = now(), rscript = /<script(.|\s)*?\/script>/gi, rselectTextarea = /select|textarea/i,
        rinput = /color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week/i,
        jsre = /=\?(&|$)/, rquery = /\?/, rts = /(\?|&)_=.*?(&|$)/, rurl = /^(\w+:)?\/\/([^\/?#]+)/, r20 = /%20/g;
    jQuery.fn.extend({
    ...
    jQuery.extend({
        ...
        param: function (a) {
            var s = [], traditional = jQuery.param.traditional;
            ...
            if (jQuery.isArray(a) || a.jquery) {
                ...
                jQuery.each(a, function buildParams(prefix, obj) {
                    if (jQuery.isArray(obj)) {
                        ...
                        if (!traditional && typeof obj === "object") {
    ...
    var elemdisplay = {}, rfxtypes = /toggle|show|hide/, rfxnum = /^([+-]=)?([\d+-.]+)(.*)$/, timerId,
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        ...
        jQuery.fn.offset = function (options) {
            ...
            var offsetParent = elem.offsetParent, prevOffsetParent = elem, doc = elem.ownerDocument, computedStyle,
